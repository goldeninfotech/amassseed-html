$(document).ready(function () {
  ...
  $("#videos-view").owlCarousel({
    ...
    autoplay: false,
    navText: [
      '<img src="assets/images/icons/curosel_arrow_left.png" alt="arrow-left">',
      '<img src="assets/images/icons/curosel_arrow_right.png" alt="arrow-right">',
    ],
...
$(document).ready(function () {
  ...
  $("#close-toggle").click(function () {
    ...
    if (window?.innerWidth >= breakpointsNavbar) {
      console.log("inner bar height");
